  ...
  return (
    <MainWarp>
      <HomeWrap>
        ...
        <Reservation onPress={() => Linking.openURL(`tel:023121247`)}><ReservationText>예약하기</ReservationText></Reservation>
      </HomeWrap>
      ...
      <HomeWrap>
        ...
        <Reservation onPress={() => Linking.openURL(`tel:023926460`)}><ReservationText>예약하기</ReservationText></Reservation>
      </HomeWrap>
      ...
      <HomeWrap>
        ...
        <Reservation onPress={() => Linking.openURL(`tel:027529020`)}><ReservationText>예약하기</ReservationText></Reservation>
      </HomeWrap>
